...
public abstract class AbstractArrayHeap<P, V> {
   ...
   */
  protected AbstractArrayHeap(final Comparator<P> comparator) {
    if (comparator == null) {
   ...
   */
  public final AbstractArrayHeap<P, V> add(final P priority, final V value) {
